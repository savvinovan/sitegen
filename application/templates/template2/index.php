    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row" style="text-align: center;">
                <div class="col-lg-4">
                    <h2 style="font-size: 20px;"><?=mb_substr($newsArr['items'][0]['title'],0,40, 'utf-8')?></h2><!-- Nazvanie novosti -->
                    <p><?=$newsArr['items'][0]['description']?></p><!-- text novosti -->
                </div>
                <div class="col-lg-4">
                    <h2 style="font-size: 20px;"><?=mb_substr($newsArr['items'][1]['title'],0,40, 'utf-8')?></h2><!-- Nazvanie novosti -->
                    <p><?=$newsArr['items'][1]['description']?></p><!-- text novosti -->
                </div>
                <div class="col-lg-4">
                    <h2 style="font-size: 20px;"><?=mb_substr($newsArr['items'][2]['title'],0,40, 'utf-8')?></h2><!-- Nazvanie novosti -->
                    <p><?=$newsArr['items'][2]['description']?></p><!-- text novosti -->
                </div>
            </div>
            <div class="row" style="text-align: center;">
              <div class="col-lg-4">
                    <h2 style="font-size: 20px;"><?=mb_substr($newsArr['items'][3]['title'],0,40, 'utf-8')?></h2><!-- Nazvanie novosti -->
                    <p><?=$newsArr['items'][3]['description']?></p><!-- text novosti -->
                </div>
                <div class="col-lg-4">
                    <h2 style="font-size: 20px;"><?=mb_substr($newsArr['items'][4]['title'],0,40, 'utf-8')?></h2><!-- Nazvanie novosti -->
                    <p><?=$newsArr['items'][4]['description']?></p><!-- text novosti -->
                </div>
                <div class="col-lg-4">
                    <h2 style="font-size: 20px;"><?=mb_substr($newsArr['items'][5]['title'],0,40, 'utf-8')?></h2><!-- Nazvanie novosti -->
