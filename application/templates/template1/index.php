    ...
    <div id="news" class="container content-padding">
      ...
      <div class="row">
        <div class="col-lg-4 news-img-center">
          <?=$newsArr['items'][0]['img']?>
          <h2 style="font-size: 20;"><?=$newsArr['items'][0]['title']?></h2> <!-- suda nazvanie novosti -->
        ...
        <div class="col-lg-4 news-img-center">
          <?=$newsArr['items'][1]['img']?>
          <h2 style="font-size: 20;"><?=$newsArr['items'][1]['title']?></h2><!-- suda nazvanie novosti -->
        ...
        <div class="col-lg-4 news-img-center">
          <?=$newsArr['items'][2]['img']?>
          <h2 style="font-size: 20;"><?=$newsArr['items'][2]['title']?></h2><!-- suda nazvanie novosti -->
      ...
      <div class="row">
        <div class="col-lg-4 news-img-center">
          <?=$newsArr['items'][3]['img']?>
          <h2 style="font-size: 20;"><?=$newsArr['items'][3]['title']?></h2><!-- suda nazvanie novosti -->
        ...
        <div class="col-lg-4 news-img-center">
          <?=$newsArr['items'][4]['img']?>
          <h2 style="font-size: 20;"><?=$newsArr['items'][4]['title']?></h2><!-- suda nazvanie novosti -->
        ...
        <div class="col-lg-4 news-img-center">
          <?=$newsArr['items'][5]['img']?>
          <h2 style="font-size: 20;"><?=$newsArr['items'][5]['title']?></h2><!-- suda nazvanie novosti -->
